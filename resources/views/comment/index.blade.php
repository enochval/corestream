...
<head> <meta charset="UTF-8">
    ...
    <script src="{{ asset('ng/js/controllers/mainCtrl.js') }}"></script> <!-- load our controller -->
    <script src="{{ asset('ng/js/services/commentService.js') }}"></script> <!-- load our service -->
    <script src="{{ asset('ng/js/app.js') }}"></script> <!-- load our application -->
...
<body class="container" ng-app="commentApp" ng-controller="mainController"> <div class="col-md-8 col-md-offset-2">
    ...
    <div class="comment" ng-hide="loading" ng-repeat="comment in comments">
        <h3>Comment #{{ comment.id }} <small>by {{ comment.user_id }}</small></h3>
        <p>{{ comment.text }}</p>
