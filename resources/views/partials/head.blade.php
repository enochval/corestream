<head>
    ...
    <!-- Counterdowntimer CSS -->
    <link href="{{ asset('assets/plugins/countdowntimer/demo/css/demo.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('css/multicarousel.css') }}" id="theme" rel="stylesheet">
