...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ url('/my-event') }}">My Events</a></li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                {!! Form::model($event, ['route' => ['event.general.update', $event->id], 'method' => 'PATCH', 'files' => true, 'class' => 'tab-wizard vertical wizard-circle']) !!}
                <!-- Step 1 -->
                    <h6>Category</h6>
                    <section>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-8 mt-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        {!! Form::text('title', null, ['class'=>'form-control', 'placeholder'=>'Enter the title of your event', 'readonly']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 mt-4">
